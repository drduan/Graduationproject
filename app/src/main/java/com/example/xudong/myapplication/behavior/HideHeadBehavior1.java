 ...
 */
public class HideHeadBehavior1 extends BaseBehavior implements NestedScrollingChild {
    ...
    public HideHeadBehavior1(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void onNestedPreScroll(CoordinatorLayout coordinatorLayout, View child, View target, int dx, int dy, int[] consumed) {
        ...
        if (dy > UP_SCROOL_VALUE && !isHeadHide ) {


            hide(child, target);
            behaviorcontext.SecondSHow = false;
            isHeadHide = true;
        } else if (dy < -DOWN_SCROOL_VALUE && isHeadHide  ) {

            show(child, target);
            behaviorcontext.SecondSHow = true;
            isHeadHide = false;
        }
    }
...
//            if (parent.getChildAt(i) instanceof ) {
//                targetIndex = i;
//                break;
// /           }
//        }
